...
| 积分详情 | CDK分数 |
|:---:|:---:|
| ![积分详情](imgs/credit.png) | ![CDK分数](imgs/cdk.png) |
...
<p align="center">
  <img src="imgs/fulllevel.png" alt="信任级别详情" width="400">
</p>

**信任级别**：显示当前等级（Lv.0-4）、今日排名、积分、注册天数，以及各项升级指标的完成进度。绿色进度条表示已达标，红色数字显示数据变化（如 ▲12 表示今日增长）
